 ...
 *
 * Distinct from `IProperty<T>` from @benkalegin/filigree-graph because an option carries
...
import { type IGraphElement, type IProperty } from '@benkalegin/filigree-graph';
